...
class G1Deployment:
    ...
    def start_camera_sensor(self):
        ...
        cmd = [
            sys.executable,
            str(self.project_root / "gr00t_wbc/control/sensor/composed_camera.py"),
            "--egoview_camera",
    ...
    def start_sim_loop(self):
        ...
        cmd = [
            sys.executable,
            str(self.project_root / "gr00t_wbc/control/main/teleop/run_sim_loop.py"),
            "--wbc_version",
    ...
    def start_teleop(self):
        ...
        cmd = [
            sys.executable,
            str(self.project_root / "gr00t_wbc/control/main/teleop/run_teleop_policy_loop.py"),
            "--body_control_device",
